...
return (
    <div className="flex flex-col md:flex-row items-center gap-6 bg-slate-900/60 p-6 rounded-2xl border border-slate-800 shadow-xl backdrop-blur-lg relative">
      <div className="flex-1 text-center">
        ...
        {/* Base de Dados (2 abas fixas) */}
        <div className="mt-3 flex items-center gap-2">
          <span className="text-[11px] font-black text-slate-400 mr-1">BASE</span>
          {[1, 2].map((id) => (
            <button
              key={id}
          ...
          <div className="ml-2 text-[11px] font-black text-slate-300 truncate">
            {`BASE ${datasetId}`}
          </div>
        </div>
